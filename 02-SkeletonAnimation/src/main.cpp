...
//Indice para seleccionar la animcacon que deseo reproducir
...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	// Cybor - Sin animacion de momento
...
void applicationLoop() {
	...
	modelMatrixGuardian = glm::translate(modelMatrixGuardian, glm::vec3(15.0, 0.0, 0.0));
	modelMatrixGuardian = glm::rotate(modelMatrixGuardian, glm::radians(-90.0f),
		glm::vec3(1, 0, 0));

	modelMatrixMayow = glm::translate(modelMatrixMayow, glm::vec3(13.0f, 0.0, -7.0));

	modelMatrixCyborg = glm::translate(modelMatrixCyborg, glm::vec3(5.0, 0.0, 0.0));
	...
	while (psi) {
		...
		*******************************************/
		...
		//guardianModelAnimate.render(glm::scale(modelMatrixGuardian, glm::vec3(0.04f)));
		
		mayowModelAnimate.setAnimationIndex(animationMayowIndex);
		mayowModelAnimate.render(glm::scale(modelMatrixMayow, glm::vec3(0.02f)));
		animationMayowIndex = 1;

		cyborgModelAnimate.setAnimationIndex(2);
		cyborgModelAnimate.render(glm::scale(modelMatrixCyborg, glm::vec3(0.005f)));
